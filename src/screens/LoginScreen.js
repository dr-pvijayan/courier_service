        ...
        <KeyboardAvoidingView behavior={"position"} style={styles.container}>
            ...
            >
                ...
                <SegmentedControlTab
                    ...
                    activeTabStyle={{ borderBottomColor: colors.GREEN.light, backgroundColor: 'transparent', borderBottomWidth: 2, marginTop: 2 }}
                    tabTextStyle={{ color: colors.WHITE, fontWeight: 'bold' }}
                    activeTabTextStyle={{ color: colors.GREEN.light }}
                />
                ...
                <View style={styles.box1}>
                    <RNPickerSelect
                        ...
                        disabled={!!state.verificationId || !features.AllCountries ? true : false}
                    />
                </View>
                : null}
                {state.customStyleIndex != 0 ?
