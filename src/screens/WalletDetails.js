  ...
  return (
    <View style={styles.mainView}>
      <Header
        ...
        rightComponent={ auth.info && auth.info.profile && auth.info.profile.usertype =='driver'?<TouchableOpacity onPress={doWithdraw}><Text style={{color:colors.BLUE.sky}}>{language.withdraw}</Text></TouchableOpacity>:null}
