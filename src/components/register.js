...
export default function Registration(props) {
    ...
    uploadImage = () => {
        ...
        return (
            <ActionSheet ref={actionSheetRef}>
                ...
                >
                    <Text style={{color:colors.BLUE.greenish_blue,fontWeight:'bold'}}>{language.camera}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                ...
                >
                    <Text  style={{color:colors.BLUE.greenish_blue,fontWeight:'bold'}}>{language.medialibrary}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
    ...
    const setUserType = (value) => {
        if(value==0){
            setState({...state, usertype: 'dispatcher' });
        }else{
    ...
    onPressRegister = () => {
        ...
        if(re.test(state.email))
        {
            ...
            // }
            //else{
                if((state.usertype == 'driver' && state.vehicleNumber.length > 1) || state.usertype == 'dispatcher'){
                    ...
                    <View style={styles.containerStyle}>
                        ...
                        <View style={[styles.textInputContainerStyle,{marginBottom:10}]}>
                            ...
                            <RNPickerSelect
                                ...
                                disabled={features.AllCountries ? false : true}
